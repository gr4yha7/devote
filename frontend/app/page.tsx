...
export default function Home() {
  ...
  const votingContractAddress = process.env.NEXT_PUBLIC_VOTING_CONTRACT_ADDRESS || "0x5FbDB2315678afecb367f032d93F642f64180aa3";
  const tokenContractAddress = process.env.NEXT_PUBLIC_TOKEN_CONTRACT_ADDRESS || "0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0";
  ...
  const { data: proposals = [], isLoading: isLoadingProposals } = useQuery({
    ...
    queryFn: async () => {
      if (!isConnected || !address || !publicClient || !proposalCount) return [];
  ...
  const createProposalMutation = useMutation({
    mutationFn: async ({ title, description }: { title: string; description: string }) => {
      if (!walletClient || !isConnected || !publicClient || !address) throw new Error('Wallet not connected');
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <Head>
        ...
        <meta name="description" content="A decentralized DAO voting application built on Ethereum" />
      ...
      <main>
        ...
        <section className="text-center py-16 px-4 bg-white">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto mb-8">
            Secure, transparent, and tamper-proof blockchain-based voting platform 
          ...
          <>
            ...
            <section className="py-16 bg-gray-50">
              <div className="container mx-auto px-4">
                <h2 className="text-3xl font-bold text-center mb-12">Why Choose DeVote?</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p className="text-gray-600">
                      All votes are recorded on the blockchain, making them immutable, 
                      verifiable, and resistant to tampering or manipulation.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p className="text-gray-600">
                      Vote from anywhere, anytime using just your wallet. No need for 
                      physical polling stations or complex identification processes.
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p className="text-gray-600">
                      The platform itself is governed by its users, ensuring that 
                      protocol upgrades and changes reflect the will of the community.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="max-w-4xl mx-auto">
                  <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-12">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Connect your Ethereum wallet to the platform. DeVote supports MetaMask, 
                        WalletConnect, and other popular wallet providers.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-12">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Explore the list of active polls and proposals. Read descriptions, 
                        view options, and check voting deadlines.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col md:flex-row items-center md:items-start gap-8 mb-12">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Select your preferred option and confirm your vote. The transaction will 
                        be signed by your wallet and recorded on the blockchain.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Once the voting period ends, results are automatically tallied and 
                        published. You can verify all votes on the blockchain explorer.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <section className="py-16 bg-blue-600 text-white">
              <div className="container mx-auto px-4 text-center">
                ...
                <p className="text-xl mb-8 max-w-2xl mx-auto">
                  Join thousands of users who are already voting securely on the blockchain.
                </p>
                <div className="mt-8">
                  <p className="text-xl text-gray-600">Connect your wallet to start voting</p>
                </div>
              </div>
            </section>
          </>
